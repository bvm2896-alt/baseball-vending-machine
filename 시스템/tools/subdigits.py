...
SINO_UNITS = '회|승|패|무|위|이닝|년|일|월|구|점|실점|득점|타점|연승|연패|연전|라운드|번째|시즌|홈런|호|할|푼|번|개'
...
def to_digits(t):
    ...
    t = re.sub(r'(?<![가-힣])(십일월|십이월|일월|이월|삼월|사월|오월|유월|칠월|팔월|구월|시월)(?![가-힣]{0}[가-힣]*월)', lambda m: f'{MONTH[m.group(1)]}월', t)
